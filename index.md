...
<section class="site-footer" style="color: $header-heading-color; text-align: center;">
 ...
 <section id="team-items">
   ...
   <section class="btn" style="border-color: rgba(0, 0, 0,0.2); color: gray;"><img src="logo.gif" alt="su" width="50"><h3>Davide Iannotta</h3></section><br><section class="btn" style="border-color: rgba(0, 0, 0,0.2); color: gray;"><h4><img src="sapienzaicon.jpg" alt="uni" width="40">Computer Engineering student at La Sapienza</h4></section>
   </section>
